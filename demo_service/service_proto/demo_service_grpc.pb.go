...
type DemoServiceClient interface {
	GetSomeData(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*DemoReply, error)
}
...
func (c *demoServiceClient) GetSomeData(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*DemoReply, error) {
	out := new(DemoReply)
	err := c.cc.Invoke(ctx, "/DemoService/GetSomeData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DemoServiceServer interface {
	GetSomeData(context.Context, *emptypb.Empty) (*DemoReply, error)
...
func (UnimplementedDemoServiceServer) GetSomeData(context.Context, *emptypb.Empty) (*DemoReply, error) {
...
func _DemoService_GetSomeData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoServiceServer).GetSomeData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/DemoService/GetSomeData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServiceServer).GetSomeData(ctx, req.(*emptypb.Empty))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _DemoService_GetSomeData_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "service_proto/demo_service.proto",
}
